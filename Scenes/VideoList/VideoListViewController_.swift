//
//  VideoListViewController2.swift
//  LiveEvents
//
...
class VideoListViewController2: BaseViewController {
...
extension VideoListViewController2 {
    @MainActor
    func startActivity() {
...
extension VideoListViewController2: UITableViewDelegate {
...
extension VideoListViewController2 {
    private func setUpRefreshControl() {
        ...
        self.refreshControl.addTarget(self,
                                      action: #selector(VideoListViewController2.refreshData(_:)),
